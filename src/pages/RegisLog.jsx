...
const RegisLog = () => {
  return (
    <section className='bg-[url(/images/form-bg.jpg)] bg-cover bg-center min-h-[100vh] bg-no-repeat'>
      <div className="bg-neutral-50 max-w-[500px] w-full h-[100vh] p-8 flex items-center">
